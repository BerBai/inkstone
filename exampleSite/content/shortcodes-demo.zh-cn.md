...
邮箱：{{< copy-to-clipboard text="user@example.com" />}}
...
```markdown
{{</* figure src="https://placehold.co/1200x600/orange/white?text=Inkstone" alt="Demo image" caption="一张带说明文字与替代文本的图。" */>}}
```
...
由 JSON 数据文件驱动。下面这份 fixture 在 `static/data/smoke/gallery.json`。
...
```markdown
{{</* wechat-qr name="我的公众号" image="/img/wechat-qr.png" */>}}
```

悬停或聚焦下面这个元素，即可看到二维码气泡：{{< wechat-qr name="Demo OA" image="/img/wechat-qr.png" >}}
